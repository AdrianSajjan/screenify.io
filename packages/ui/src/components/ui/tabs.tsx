...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "flex h-12 items-center justify-center rounded-base border-2 border-border bg-light text-text divide-x-2 overflow-hidden",
      className,
    )}
    {...props}
  />
